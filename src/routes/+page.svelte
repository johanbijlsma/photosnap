...
<div class="wrapper">
	...
	<div class="about">
		<ul>
			<li>
				100% Responsive No matter which the device you’re on, our site is fully responsive and
				stories look beautiful on any screen.
			</li>
			<li>
				No Photo Upload Limit Our tool has no limits on uploads or bandwidth. Freely upload in bulk
				and share all of your stories in one go.
			</li>
			<li>
				Available to Embed Embed Tweets, Facebook posts, Instagram media, Vimeo or YouTube videos,
				Google Maps, and more.
			</li>
		</ul>
	</div>
	<footer>Home Stories Features Pricing Get an invite Copyright 2019. All Rights Reserved</footer>
</div>
